...
% print(plot_pdf, 'MSE_kfold.pdf', '-dpdf', '-r0')
% 
% % Save png
% print(gcf,'MSE_kfold.png','-dpng','-r600');
...
%     'PaperSize',[pos(3), pos(4)]);
% print(plot_pdf2, 'MSE_kfold_error.pdf', '-dpdf', '-r0')
% 
% % Save png
% print(gcf,'MSE_kfold_error.png','-dpng','-r600');
