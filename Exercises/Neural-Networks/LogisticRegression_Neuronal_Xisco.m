function [MSE_train, MSE_test]=LogisticRegression_Neuronal_Xisco(percentage,d,plot_bool,lambda)
...
[thetaOpt,fval,exitflag,output] = solveTheta(X,Ytrain,theta0_vec,lambda,m,num_capas);
MSE_train=fval;
if plot_bool
    figure(1)
...
function [theta,fval,exitflag,output] = solveTheta(X,Ytrain,theta,lambda,m,num_capas)
